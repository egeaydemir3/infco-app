      ...
      <div className="relative z-10 flex-1 overflow-y-auto">
        <div className="p-8 max-w-7xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <h2 className="text-3xl font-bold text-white mb-2">Kullanıcı Onay Paneli</h2>
            <p className="text-gray-400">Bekleyen kullanıcıları inceleyip onaylayabilirsiniz.</p>
          </div>

          {/* Client Component - Tablo */}
          <AdminUsersTable users={pendingUsers} />
        </div>
      </div>
    </div>
  )
